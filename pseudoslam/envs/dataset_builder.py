...
def main():
    config_file= path.join(path.dirname(__file__), "config", "dataset_config.yaml")

#read files for image names
    ...
    while 1:
        ...
        plt.axis('off')
        plt.pause(0.001)
        #fig_map.savefig("HouseExpo/images/test.png")	# uncomment this if you want save figure
        ...
        if v==1:
            ...
            sim.reset()
            counter=counter+1
            fig_map.savefig("images/image"+str(counter)+".png")
